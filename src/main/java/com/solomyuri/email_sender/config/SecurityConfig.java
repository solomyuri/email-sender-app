package com.solomyuri.email_sender.config;
...
import com.solomyuri.email_sender.exception.AuthErrorHandler;
...
public class SecurityConfig {
	...
	http.authorizeHttpRequests(auth -> auth.anyRequest().hasAuthority("email-sender"));
